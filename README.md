...
In the music generated by RNN-VAE-GAN, in all pieces of music generated, the treble clef has more notes compared to the bass clef but they did not complement very well. All the notes generated also are very random producing a noise rather than music. This indicates little and almost no structure of music elements which increases the disorderness of music elements in the generated music. In the sense of melody, the music generated has little melody to the music causing it to produce unpleasant sounds. However, the generation of music itself is better compared to the individual models (LSTM, VAE, and GANs) in terms of musical composition and the diversity of music generated. 
